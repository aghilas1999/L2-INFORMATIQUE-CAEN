 ...
 * <p>
 * Note: this class uses three integers for representing the birth
 * date, but it may be interesting to implement a version using
...
public class Person {
    ...
    /**
     * Builds a new person. Note that no verification is made of
     * the validity of the birth date.
     * @param name The person's name
     * @param birthYear The year when the person was born
     * @param birthMonth The month when the person was born
    ...
    public String getPresentation () {
        return
            "I am " + this.name + ", born " + this.birthDateToString() +
            ", and I am " + this.getCurrentAge() + " years old.";
    }

    // Methods about birth date and age ========================================

    /**
     * Returns this person's age at a given date. Note that no
     * verification is made of the validity of the given year.
     * @param year The year when to evaluate the person's age
     * @param month The month when to evaluate the person's age
     * (1 for January, ..., 12 for December)
